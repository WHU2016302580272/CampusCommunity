...
<div id="logined_show" align="right">
    <div id="div1_user_icon">
        <%--//加载icon--%>
        <img id="div1_small_icon_img" class="icon_bell" src="/resource/icon.jpg" onmouseover="user_icon_bigger()"
             onmouseout="user_icon_smaller()">
    </div>
</div>
...
<div style="min-width: 500px">
    <div id="navIcons"><!--选项卡部分-->
        ...
        <div class="navSpace navIcon" id="star" onclick="favoriteList()">
    ...
    function print() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                document.getElementById("avatar").src = "data:" + myAvatar;
                msg(arr);
            },
            error: function () {
                alert("error");
